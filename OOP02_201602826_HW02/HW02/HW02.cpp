...
class NamingConventionCorrector {
  // To covention nameing useing temp sting and transfrom
 public:
  std::string ToTypeName(std::string* input, int size) {
    // To convention type name
    std::string temp;
  ...
  std::string ToClassMemberName(std::string* inputLine, int size) {
    // To convention class member name
    std::string temp;
    for (int i = 0; i < size; i++) {
      temp += inputLine[i] + "_";
    }
  ...
  std::string ToStructMemberName(std::string* inputLine, int size) {
    // To convention struct member name
    std::string temp;
    for (int i = 0; i < size; i++) {
      temp += inputLine[i] + "_";
    }
